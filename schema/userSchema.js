...
const userSchema = new mongoose.Schema({
    firstName : {
        ...
        minlengrh : [5, "First name must be at least 5 Charecters"],
        lowercase : true,
        trim : true,
    ...
    lastName : {
        ...
        minlengrh : [5, "Last name must be at least 5 Charecters"],
        lowercase : true,
        trim : true,
    ...
    password : {
        ...
        minlengrh : [6, "Password must be at least 6 Charecters"],
    }
}, {timestamps : true})
